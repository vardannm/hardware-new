    ...
    <footer className="text-center py-[54px]  bg-[#DFDFDF] text-gray-400 text-sm flex flex-col ">
                ...
                <div className="flex text-black justify-between max-sm:flex-col-reverse pl-2">
                  ...
                  <div className="flex flex-col max-sm:flex-row  gap-4 pt-[15px] max-sm:gap-18">
                    ...
                    <a className="font-medium" href="/services">Services</a>
                    </div>
                    <div className="flex flex-col gap-4 align-start items-start">
                    <a className="font-medium" href="/industries">Industries</a>
                       <a className="font-medium" href="/blog">Blog</a>
                    <a className="font-medium" href="/faq">FAQ</a>
                    </div>
                    <div className="flex flex-col gap-4 align-start items-start">
                    <a className="font-medium" href="/about-us">About us</a>
                    <a className="font-medium" href="/contact-us">Contact us</a>
                    </div>
                  </div>
                  </div>
                  {!isContactPage && (
          ...
          onChange={(e) => setMessage(e.target.value)} />
                ...
                <div className="flex justify-between my-10 max-sm:mx-auto">
                 <div className="flex gap-9 pl-2 max-sm:pl-0 max-sm:mx-auto">
                  <a href="https://www.facebook.com/hardwaredesignhouse/."><FaFacebookF color="black" size={20}/></a>
                  <a
