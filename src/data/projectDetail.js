...
//moon images
import SmartHomeHub from "@/public/moon/smart-home-hub.jpg";
import SmartHomeHubDegree from "@/public/moon/smart-home-hub-360-degree-camera.png";
...
export const PROJECT_DETAILS = {
  "smart-bedroom-lighting-system": {
    ...
    hero: {
      ...
      title: "zLight",
      subtitle: "Smart Bedroom Lighting System",
      text: "A sleep box that uses gentle light to guide your sleep and wake cycle.",
      icon: ZlightIcon,
    },
    technicalApproach: {
  ...
  "smart-thermostat-system": {
    ...
    hero: {
      ...
      subtitle: "",
      text: "The Smart Thermostat System is a smart system that simplifies home climate control with an intuitive interface and optimized energy management. Featuring custom schedules, live weather updates, and air quality monitoring, it gives users complete control over heating, cooling, and ventilation. Designed with homeowners in mind, the system combines ease of use with accessible installation guides and troubleshooting tools, ensuring smooth setup and efficient operation.",
      icon: Thermostat,
    },
    technicalApproach: {
      image: SmartBedroomHub,
...
The thermostat is made up of a main unit and a backplate. The main unit includes the main processor and the user interface display, while the backplate provides connection with the HVAC system and represents the switching system. For switching, solid-state relays were used in pairs with overcurrent protection circuitry.`,
   ...
   processHighlights: [
    ...
    perks: [
       {
          ...
          },
          {
            ...
            title:
              "Intuitive Interface and Self-Diagnostics in Smart Thermostat System",
            width: 352,
          },
          {
    ...
    galleryImages: Array(7).fill(zlighSwipper), // կամ տարբեր նկարներ
    finalText:
      "The Smart Thermostat System makes home climate control simple, efficient, and reliable. Easy to install and use, it’s built to support homeowners while staying ready for future upgrades.",
  },
  ...
  "smart-home-hub": {
    ...
    hero: {
      ...
      subtitle: "Transforming Smart Home Technology",
      text: "Moon by 1-Ring is a smart home security and automation system that  brings all your devices together in one place. It keeps an eye on your home, automates everyday tasks, and offers all-around coverage, while working with Wi-Fi, Bluetooth, Zigbee, and Z-Wave so everything just connects and works smoothly.",
      icon: SmartHomeHub,
    },
    technicalApproach: {
