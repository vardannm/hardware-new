...
export const metadata = {
  alternates: { canonical: "https://www.hardwarehouses.com/services/" },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Hardware Design House (HDH) provides full-cycle hardware engineering services including electronics design, prototyping, testing, manufacturing support, and embedded systems engineering for production-ready products.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "End-to-end hardware engineering services, electronics design, prototyping, testing, and manufacturing support for production-ready electronic products.",
            inLanguage: "en",
          }),
        }}
      />
